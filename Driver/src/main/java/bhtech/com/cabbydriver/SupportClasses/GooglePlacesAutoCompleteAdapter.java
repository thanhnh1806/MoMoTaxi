package bhtech.com.cabbydriver.SupportClasses;
...
public class GooglePlacesAutoCompleteAdapter extends ArrayAdapter<PlaceAutocomplete>
    ...
    public GooglePlacesAutoCompleteAdapter(Context context, AutocompleteFilter filter,
                                           GoogleAutoCompleteInterface listener) {
        super(context, R.layout.google_place_list_item);
        this.context = context;
        mBounds = new LatLngBounds(new LatLng(37.398160, -122.180831), new LatLng(37.430610, -121.972090));
        mPlaceFilter = filter;
